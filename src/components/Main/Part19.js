    ...
    return (
        <div className="w-full text-left py-16 px-60">
            ...
            <div className="my-8">
                ...
                <p className="text-base">Developed by Insomniac Games, Inc</p>
            </div>
            <div>
                <p className="text-base mb-6 leading-7">
                    <sup>1. </sup>สามารถใช้งานได้ในเกมที่รองรับฟีเจอร์
                </p>
                <p className="text-base mb-6 leading-7">
                    <sup>2. </sup>การเล่นเกม PS VR บนคอนโซล PS5 ต้องใช้แว่น PS
                    ...
                    PlayStation Move หรือเข้ากันได้กับคอนโทรลเลอร์ PlayStation
                    VR Aim กล้อง HD รุ่นใหม่สำหรับ PS5 ไม่สามารถใช้ได้กับ PS VR
                    ชุดหูฟัง PS VR, กล้อง PS, คอนโทรลเลอร์ไร้สาย DUALSHOCK 4,
                    คอนโทรลเลอร์ PS Move และคอนโทรลเลอร์ PS VR Aim
                    ทั้งหมดจำหน่ายแยกต่างหากจากคอนโซล PS5
                </p>
                <p className="text-base mb-6 leading-7">
                    <sup>3. </sup>ค่าธรรมเนียมการสมัครสมาชิก PlayStation Plus
                    จะถูกเรียกเก็บซ้ำจนกว่าจะถูกยกเลิก มีการจำกัดอายุในการใช้
                    ...
                    จำนวนและความพร้อมใช้งานของเกม PlayStation Plus Collection
                    อาจแตกต่างกันไปในแต่ละประเทศ ดู{" "}
                    <span
                        className="cursor-pointer underline"
                        style={{ color: "#0072ce" }}>
                        playstation.com/psplus
                    </span>{" "}
                    สำหรับรายละเอียดและข้อมูลล่าสุดเกี่ยวกับข้อเสนอของ PS Plus
                </p>
                <p className="text-base mb-6 leading-7">
                    <sup>4. </sup>
                    อาจมีการเสนอการอัปเกรดโดยไม่มีค่าใช้จ่ายเพิ่มเติมหรือมีค่าธรรมเนียม
                    และอาจมีในช่วงเวลาจำกัด หากต้องการอัปเกรดแผ่นดิสก์เกม PS4
                    เป็นเวอร์ชัน PS5 ดิจิตอล คุณจำเป็นต้องมีคอนโซล PS5
                    ที่มีดิสก์ไดรฟ์
                    ...
                    ต้องมีอินเทอร์เน็ตและบัญชีสำหรับ PlayStation Network
                    เจ้าของบัญชีต้องมีอายุ 7 ปีขึ้นไป ผู้ใช้ที่มีอายุต่ำกว่า 18
                    ปีต้องได้รับความยินยอมจากผู้ปกครอง เงื่อนไขข้อกำหนดแบบเต็ม –{" "}
                    <span
                        className="cursor-pointer underline"
                        style={{ color: "#0072ce" }}>
                ...
                <p className="text-base mb-6 leading-7">
                    “PlayStation” “เครื่องหมาย PlayStation Family" “โลโก้ PS5”
                    "DualSense" และ "Play Has No Limits"
